...
export default function FeaturedRelease({image, title, cta, badgeText}) {
  return (
    <>
    <div class={styles.featured_release}>
      ...
      <div class={styles.featured_release_card}>
        <img class={styles.featured_image} src={image} />
        <div class={styles.featured_text}>
          <h3>{title}</h3>
          <div class={styles.cta}>
            <IconPlay />
            <p class="utility">{cta}</p>
          </div>
        </div>
      </div>
    </div>
